...
<div style="text-align: center;"><img src="../img/{{ model_path }}/ardupilot-integration/navio2-reach.png" style="width: 500px;"></div>

Connect Reach's **{{ power_port }}** port with Navio's **UART** port.

## Connecting Reach {{ model }} to Navio2 over USB

<div style="text-align: center;"><img src="../img/{{ model_path }}/ardupilot-integration/navio2-reach-usb.png" style="width: 500px;"></div>
...
<div style="text-align: center;"><img src="../img/{{ model_path }}/ardupilot-integration/reach-position-output.png" style="width: 100%;"></div>
...
<div style="text-align: center;"><img src="../img/{{ model_path }}/ardupilot-integration/mp-serial4-baud-parameter.png" style="width: 800px;"></div>
