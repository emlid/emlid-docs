...
##Turning Reach {{model}} on

Press Reach {{model}} power button and wait until it boots.
{% if model == "Module" or model == "M2" or model == "RS" or model == "RS+" %}
...
### Reach {{model}} is in hotspot mode
