...
Electronic devices may produce RF noise that could affect the reception of the GNSS signal. Keep all electronics (including the Reach {{model}} itself) as far as possible from the antenna.
