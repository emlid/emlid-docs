...
<p style="text-align:center" ><img src="../img/reachview/status/{{ model_path }}/status.png" style="width: 800px;" /></p>
...
<p style="text-align:center" ><img src="../img/reachview/status/{{ model_path }}/rtk_parameters.png" style="width: 550px;" /></p>
...
<p style="text-align:center" ><img src="../img/reachview/status/{{ model_path }}/map.png" style="width: 800px;" /></p>
...
<p style="text-align:center" ><img src="../img/reachview/status/{{ model_path }}/position.png" style="width: 800px;" /></p>
