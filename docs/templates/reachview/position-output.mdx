...
Reach supports the following position output formats: 
...
You can learn more about getting Reach {{mode}} coordinates on Android via Bluetooth in [this](../../common/tutorials/mock-location.md)  guide.
