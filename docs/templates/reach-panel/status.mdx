...
<p style="text-align:center" ><img src="../img/reachview/status/reach2/status.png" style="width: 800px;" /></p>
{% else %}
...
{% if model == "RS2" or model == "M2" %}
<p style="text-align:center" ><img src="../img/reachview/status/reach2/rtk_parameters.png" style="width: 550px;" /></p>
{% else %}
