...
<p style="text-align:center" ><img src="../img/reach-panel/status/reach2/status.png" style="width: 800px;" /></p>
{% else %}
...
{% if model == "RS2" or model == "M2" %}
<p style="text-align:center" ><img src="../img/reach-panel/status/reach2/rtk_parameters.png" style="width: 550px;" /></p>
{% else %}
...
{% if model == "RS/RS+" or model == "M+" or model == "RTK" %} 
### AR validation ratio  
...
### Baseline
Baseline is the distance from rover to the base. It should be kept within {{ rtk_baseline }}, if it is increased further you might experience slower fix time and lower accuracy. Accuracy is decreased by 1mm each km of baseline. 
