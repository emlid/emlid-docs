...
| For Reach RS2 |
|:-----------:|
|[**Reach RS2 Firmware 26 [ZIP, 350 MB]**](https://files.emlid.com/images/reach-rs2-v26.0.zip), [(md5)](http://files.emlid.com/images/reach-rs2-MD5SUMS)|
...
|For Reach M+|
|:-------------:|
|[**Reach M+ Firmware 26 [ZIP, 370 MB]**](https://files.emlid.com/images/reach-plus-v26.0.zip), [(md5)](http://files.emlid.com/images/reach-plus-MD5SUMS)|
...
|For Reach M2|
|:-------------:|
|[**Reach M2 Firmware 26 [ZIP, 345 MB]**] (https://files.emlid.com/images/reach-m2-v26.0.zip), [(md5)](http://files.emlid.com/images/reach-m2-MD5SUMS)|
...
| For Reach Module |
|:-----------:|
| [**Reach Module Firmware 26 [ZIP, 185 MB]**](https://files.emlid.com/images/reach-rs-v26.0.zip), [(md5)](http://files.emlid.com/images/reachview-MD5SUMS)     |
...
* Connect Reach in Firmware Update mode:
	...
	* All LEDs should blink several times simultaneously, and then start blinking one after another
    <br> <p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/connect_fel.webp" style="width: 400px;" /></p>
...
??? note "Connect Reach RS"
	...
	* Follow the instructions
	<p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/app-step2-connect.png" style="width: 300px;" /></p>
...
<p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/app-step3-select-firmware.png" style="width: 300px;" /></p>
...
<p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/app-step4-flashing.png" style="width: 300px;" /></p>
...
<p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/app-step5-rebooting.png" style="width: 300px;" /></p>

{%endif%}

* When Reach {{model}} successfully reboots, you will see "Reach is flashed and ready to use" message

<p style="text-align:center" ><img src="../img/reach-panel/firmware-reflashing/{{model_path}}/app-step5-flashed.png" style="width: 300px;" /></p>
