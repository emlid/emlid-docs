...
|Windows|Linux|
|:-------------:|:----------:|
|[Download [EXE, 81.9 MB]](http://files.emlid.com/flash-tools/win/reach-firmware-flash-tool_1.2.1_setup.exe)|[Download [DEB, 109.8 MB]](http://files.emlid.com/flash-tools/linux/reach-firmware-flash-tool_1.2.1_amd64.deb)|
